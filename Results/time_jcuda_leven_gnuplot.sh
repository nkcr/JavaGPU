...
set output "time_jcuda_leven-5x.pdf"
set title "GPLevenshtein - time comparison with jcuda and vanilla"
...
plot '../Analysis/JCuda/Levenshtein/stats/10k-50k-100k-200k-300k-400k-500k-x5.csv' with lines lt 7,\
